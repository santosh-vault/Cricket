      ...
      <article className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-2/3">
            {/* Header */}
            <header className="bg-gray-50 py-8 rounded-xl mb-6">
              <div className="px-0">
                <Link
                  to="/news"
                ...
                <h1 className="text-3xl md:text-2xl font-bold text-gray-900 mb-6 leading-tight md:leading-loose">
                  {post.title}
                </h1>
                <div className="flex flex-wrap items-center gap-6 text-gray-600">
                  ...
                  <div className="flex items-center">
                    ...
                    <span>Cricket Fantom Editorial Team</span>
                  </div>
                  <button
                    onClick={handleShare}
                  ...
                  <div className="">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {relatedPosts.map((relatedPost) => (
                        ...
                        >
                          <div className="h-32 bg-gray-200 flex items-center justify-center rounded-t-lg overflow-hidden">
                            {relatedPost.thumbnail_url ? (
                              ...
                              <div className="text-blue-400 text-center w-full h-full flex items-center justify-center">
